...
export default async function Home() {
  ...
  return <><Header/><main>
  <section className="hero commercial-hero"><div className="container-site hero-content"><p className="eyebrow">Perfumaria original</p><h1>Sua presença começa<br/><em>pela fragrância.</em></h1><p className="hero-copy">Perfumes importados e árabes <b>100% originais.</b></p><div className="hero-actions"><div className="hero-discount"><BadgePercent/><strong>8% OFF no PIX</strong></div><a className="btn-primary" href="#catalogo">Explorar perfumes <ArrowRight size={17}/></a></div></div></section>
