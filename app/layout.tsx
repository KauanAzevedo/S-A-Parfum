...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="pt-BR" className={`${cormorant.variable} ${montserrat.variable}`}><body><SplashScreen/><SessionTimeout/>{children}<a className="whatsapp" href="https://wa.me/5500000000000" aria-label="Falar no WhatsApp"><img src="/whatsapp.svg" alt="" aria-hidden="true"/><span className="sr-only">WhatsApp</span></a></body></html>}
